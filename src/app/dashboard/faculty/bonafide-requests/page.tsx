...
export default function FacultyBonafideRequestsPage() {
  ...
  // Only faculty from specific department can view
  ...
  const fetchRequests = async () => {
    try {
      ...
      const res = await fetch(`/api/bonafide-certificates?department=${profile.department}&status=${statusFilter === 'all' ? '' : statusFilter}`, {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Review and approve bonafide requests from {profile.departmentName || 'your department'} students</p>
        </div>
      </div>
                ...
                <Card key={cert._id} className="p-4 border">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground mb-2">Purpose: {cert.purpose}</p>
